...
import by.vlad.task_xml.builder.DeviceStaxBuilder;
...
public class DeviceStaxBuilderTest {
    private DeviceStaxBuilder deviceStaxBuilder;
    ...
    public void testBuildDeviceSet() throws CustomDeviceException {
        ...
        deviceStaxBuilder.buildSetDevices(xmlPath);
        Set<Device> actual = deviceStaxBuilder.getDevices();
